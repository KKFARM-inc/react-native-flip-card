...
export default class FlipCard extends Component {
  constructor (props) {
    ...
    const swipeDirection = props.swipeDirection
    this.state = {
      isFlipped: isFlipped,
      isFlipping: false,
  ...
  _toggleCard (swipeDirection) {
    this.setState({isFlipping: true,swipeDirection})
  ...
  render () {
    ...
    // flip left
    if (this.props.flipHorizontal && !this.state.isFlipped &&this.state.swipeDirection=='left') {
      transform.push(
    ...
    // flip right
    if (this.props.flipHorizontal && !this.state.isFlipped &&this.state.swipeDirection=='right') {
      transform.push(
        {rotateY: this.state.rotate.interpolate({
          inputRange: [0, 1],
          outputRange: [ '0deg', '-180deg' ]
